...
- Uses Chrome Extension Manifest V3 with strict Content Security Policy
- Implements a service worker for background RPKI data fetching with rate limiting
...
- `manifest.json` - Extension manifest with strict CSP
...
- `background.js` - Service worker with security validations and rate limiting
- `README.md` - This file
